...
class CustomOnBoardingWidget extends StatefulWidget {
  ...
  const CustomOnBoardingWidget({Key key,  this.pages,  this.selectedIndicatorColor,  this.unSelectedIndicatorColor,  this.skipWidget,  this.doneWidget}) : super(key: key);
