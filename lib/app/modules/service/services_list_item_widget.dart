...
class ServicesListItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.toNamed(Routes.E_SERVICE, arguments: {'eService': _service, 'heroTag': 'service_list_item'});
      },
      child: Container(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: [
                            ...
                            child: Chip(
                              ...
                              label: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(_service.price.toString(), style: Get.textTheme.bodyText2.merge(TextStyle(color: Get.theme.colorScheme.secondary, height: 1.4))),
                                ],
                              ),
                      ...
                      Ui.getPrice(_service.price.toDouble(), style: Get.textTheme.headline6),
                    ],
                  ),
                  Row(
                    children: [
