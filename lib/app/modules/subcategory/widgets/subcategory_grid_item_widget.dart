...
class SubcategoryGridItemWidget extends StatelessWidget {
  final SubCategory category;
  final String heroTag;

  SubcategoryGridItemWidget({Key key, this.category, this.heroTag})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Get.toNamed(Routes.SERVICES, arguments: category);
      },
      child: Container(
