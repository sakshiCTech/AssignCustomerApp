...
import 'package:home_services/app/global_widgets/block_button_widget.dart';
import 'package:home_services/app/global_widgets/circular_loading_widget.dart';
...
class EServiceView extends GetView<EServiceController> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        EServiceTilWidget(
                          ...
                          content: Ui.applyHtml(_eService.description.en, style: Get.textTheme.bodyText1),
                        ),
                          ...
                          content: Column(
                            children: [
                              ...
                              Wrap(
                                ...
                                children: Ui.getStarsList(2, size: 32),
                              ),
                              Text(
  ...
  Container buildDuration(Service _eService) {
    return Container(
  ...
  CarouselSlider buildCarouselSlider(Service _eService) {
    return CarouselSlider(
      ...
      items: <String>[_eService.imageUrl].map((String url) {
        return Builder(
  ...
  Container buildCarouselBullets(Service _eService) {
    return Container(
      margin: EdgeInsets.symmetric(vertical: 100, horizontal: 20),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: <String>[_eService.image].map((String url) {
          return Container(
            width: 20.0,
            height: 5.0,
            ...
            decoration: BoxDecoration(
                ...
                color: controller.currentSlide.value == 0 ? Get.theme.hintColor : Get.theme.primaryColor.withOpacity(0.4)),
          );
        }).toList(),
      ),
    );
  ...
  EServiceTitleBarWidget buildEServiceTitleBarWidget(Service _eService) {
            ...
            children: [
              Expanded(
                child: Wrap(
                  ...
                  children: List.from(Ui.getStarsList(5.0))
                    ..addAll([
                      SizedBox(width: 5),
                      Text(
                        "Reviews (%s)".trArgs(["_eService.totalReviews.toString()"]),
  ...
  // Widget buildCategories(Service _eService) {
  //   return Padding(
  ...
  Widget buildServiceProvider(Service _eService) {
  ...
  Widget buildBottomWidget(Service _eService) {
    return Container(
      ...
      child: Row(
        children: [
          if ("_eService.priceUnit == 'fixed'".isNotEmpty)
            Container(
              decoration: BoxDecoration(
          ...
          if ("_eService.priceUnit == 'fixed'".isNotEmpty) SizedBox(width: 10),
          Expanded(
