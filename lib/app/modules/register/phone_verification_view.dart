...
import 'package:home_services/app/modules/register/register_logic.dart';
...
class PhoneVerificationView extends GetView<RegisterLogic> {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    TextFieldWidget(
                      ...
                      onChanged: (input) => controller.otp = input,
