        ...
        children: [
          Obx(() {
            if (!Get.find<AuthService>().isAuth) {
              ...
              return GestureDetector(
                onTap: () async {
                  await Get.find<RootLogic>().changePage(3);
                },
                  ...
                  currentAccountPicture: Stack(
                    children: [
                      ...
                      Positioned(
                        top: 0,
                        right: 0,
                        child: Get.find<AuthService>().user.value!=null ?? false ? Icon(Icons.check_circle, color: Get.theme.colorScheme.secondary, size: 24) : SizedBox(),
                      )
                    ],
                  ),
                ),
          ...
          DrawerLinkWidget(
            ...
            onTap: (e) async {
              Get.back();
              await Get.find<RootLogic>().changePage(0);
            },
          ),
          DrawerLinkWidget(
          ...
          DrawerLinkWidget(
            ...
            onTap: (e) async {
              Get.back();
              await Get.find<RootLogic>().changePage(1);
            },
          ),
          DrawerLinkWidget(
          ...
          DrawerLinkWidget(
            ...
            onTap: (e) async {
              Get.back();
              await Get.find<RootLogic>().changePage(2);
            },
          ),
          ListTile(
            dense: true,
